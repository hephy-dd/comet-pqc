...
class UtilsTest(unittest.TestCase):
    ...
    def test_from_table_unit(self):
        self.assertEqual(0.001, utils.from_table_unit(1.0))
        self.assertEqual(0.042, utils.from_table_unit(42.0))

    def test_to_table_unit(self):
        self.assertEqual(1000.0, utils.to_table_unit(1))
        self.assertEqual(420.0, utils.to_table_unit(.42))
